...
\begin{enumerate}[nosep]
  ...
  \item An \textbf{empirical dataset} covering 55 HarmonyOS applications across multiple categories, with over 27,000 scraped comments.
\end{enumerate}
...
project/
  app.json                  # 55 target app definitions
...
The scraping pipeline was executed against 55 HarmonyOS applications listed in Table~\ref{tab:apps}. The selection covers a diverse range of categories:
