...
\begin{frame}[fragile]{Stage 1: Comment Scraping}
  \begin{columns}[T]
    ...
    \begin{column}{0.52\textwidth}
      ...
      \begin{lstlisting}[language=Python, xleftmargin=1.5em, xleftmargin=1.5em]
  ...
  \begin{columns}[T]
    \begin{column}{0.38\textwidth}
      ...
      \begin{itemize}
        ...
        \item \textbf{LLM groups directly, no embedding step}
        \item System Prompt injects domain rules: merge synonyms, ignore device-model differences, split multi-issue comments
    ...
    \begin{column}{0.62\textwidth}
      \begin{exampleblock}{Example: Friend Information Missing in HarmonyOS WeChat}
        \footnotesize
        ...
        \begin{tabular}{@{}p{0.48\textwidth}p{0.48\textwidth}@{}}
          \footnotesize \textbf{\#264} \quad \textit{华为畅享 90 Pro Max} &
          \footnotesize \textbf{\#272} \quad \textit{HUAWEI Pura 70 Pro+} \\[2pt]
          \footnotesize ``好友来源、好友共同群聊、添加好友时间等都没有，求更新'' &
          \footnotesize ``连朋友资料都没，版本比别人低，别的是8.0.71，我们的是8.0.17'' \\
        \end{tabular}
      \end{exampleblock}
    \end{column}
  \end{columns}
